...
function Select_Ward_Modal(props) {
    return (
        <Modal
            isVisible={props.visible_ward}
            ...
            <View style={styles.view_body}>
                <View style={styles.view_container}>
                    <View style={styles.view_top}>
                        ...
                        <Text style={styles.txt_title}>Chọn Xá/Phường</Text>
...
export default Select_Ward_Modal;
